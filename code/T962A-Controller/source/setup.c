...
float Setup_getValue(int item)
{
    ...
    retval = (((float)intval) * setupmenu[item].multiplier);
...
/**
**  @brief Setup_printFormattedValue
**	@param[in,out] 
**	@return Description of returned value.
*/
...
/**
**  @brief Setup_snprintFormattedValue
**	@param[in,out] 
**	@return Description of returned value.
*/
